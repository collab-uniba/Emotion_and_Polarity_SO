...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        if (numArgs == 5 || numArgs == 12 || numArgs== 13 || numArgs== 14 ) {
            ...
            if(type.equals("classification") || type.equals("training")) {
                ...
                try {
                    ...
                    if (!createFormatForPoliteness) {
                        ...
                        cl.tf_idf(documents, unigrams, 1, "unigrams", path, type);
                        cl.tf_idf(documents, bigrams, 2, "bigrams", path, type);
                        ...
                        cl.tf_idf(documents, u.createMap(pos), 1, "positives", path, type);
                        cl.tf_idf(documents, u.createMap(neg), 1, "negatives", path, type);
                        cl.tf_idf(documents, u.createMap(neu), 1, "neutrals", path, type);
                        cl.tf_idf(documents, u.createMap(ambiguos), 1, "ambiguos", path, type);
